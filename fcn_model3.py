...
class FCN8s(nn.Module):
    def __init__(self, num_classes):
        ...
        # self.cropfull = torchvision.transforms.CenterCrop((384, 512))
    ...
    def forward(self, x):
        ...
        # upscore2 = v2.CenterCrop(size=score_4.size)(upscore2)
        ...
        # upscore4 = v2.CenterCrop(size=score_3.size)(upscore4)
        ...
        # upscore_final = v2.CenterCrop(size=x.size)(upscore_final)
        # crop_final = self.cropfull(upscore_final)
